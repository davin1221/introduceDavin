            ...
            <div className="about_third_line">
              {aboutSub == "des" ? (
                <div className="about_description">
                  안녕하세요 신입 웹 개발자 <span>김다빈</span>입니다!
                  <br />
                  저의 20대는 진로에 대한 고민과 선택의 연속이었습니다.
                  <br />
                  그러던 중 <span>개발자</span>라는 직업을 알게 되었습니다.
                  <br />
                  프로젝트를 진행하며 완성하고 오류를 고쳐가며 살면서 처음으로{" "}
                  <span>성취감</span>을 맛보았습니다.
                  <br />
                  또, 밤낮으로 팀원들과 프로젝트를 하며 <span>
                    팀워크
                  </span>와 <span>협력</span>에 대한 것도 알게 되었습니다.
                  <br />
                  공부는 어려웠지만, 그 어려움을 이기는 과정과 결과물이 너무나도
                  매력적이었기에 앞으로 저는{" "}
                  <span>개발자로서 성장해 보고자 합니다.</span>
